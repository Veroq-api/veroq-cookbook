...
### v2.0 — Verified Swarm & Agent Runtime

| Example | Description | Language |
|---------|-------------|----------|
| [verified-swarm-analysis.py](examples/verified-swarm-analysis.py) | 5-agent verified swarm with confidence scoring | Python |
| [multi-vertical-runtime.ts](examples/multi-vertical-runtime.ts) | Agent Runtime across finance, legal, research verticals | TypeScript |
| [enterprise-governance.py](examples/enterprise-governance.py) | Enterprise audit trails, escalation, decision lineage | Python |
| [external-mcp-market-data.ts](examples/external-mcp-market-data.ts) | External MCP integration with trust levels | TypeScript |
